...
outfile = "\\dev\\rubywork\\koala\\output\\count_country_ymr_g_3.out"
...
y_response = @graph.get_connection('YANMAR.Global.Official','insights/page_fans_country/lifetime?&since=2017-3-07&until=2017-3-28')
posts = []
